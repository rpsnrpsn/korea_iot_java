...
public class H_Operator {
    public static void main(String[] args) {
        ...
        System.out.println(number++); // 출력(10) 후 + 1
        System.out.println(number--); // 출력(11) 후 - 1
        System.out.println(number); // 10
        ...
        System.out.println(number += 3); // number + 3 의 결과를 number에 할당(number = number + 3) (13)
        ...
        int x = 10, y = 2; // 변수의 데이터 타입이 다룬 경우, 콤마로 구분하여 나열 가능
