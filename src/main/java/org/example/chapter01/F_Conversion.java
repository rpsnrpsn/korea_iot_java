...
public class F_Conversion {
    ...
    public static void main(String[] args) {
        ...
        bigBox = smallBox; // 재할당 - 기존에 변수에 새로운 값을 할당(삽입)

        // cf) 변수는 재할당 시 기존의 값이 새로운 값으로 변환됨
        ...
        //char f = e; - 묵시정 형 변환 불가 (char는 2byte)
        ...
        // cf) 유니코드(Unicode)
        // : 전 세꼐의 모든 문자를 하나의 숫자(코드 값)로 표현하는 국제 표준
        // - 유니코드 이전은 각 국가에서 나라별 문자 인코딩 방식 사용(영어: 아스카, 한국어: EUC-KR)
