...
public class StudentManagement {
    public static void main(String[] args) {
        ...
        dummyStudents.add(new Student(1, "ㅂㅎㅇ", 22, "1111"));
        dummyStudents.add(new Student(2, "ㅂㅎㅁ", 25, "2222"));
        dummyStudents.add(new Student(3, "ㅂㅎㅂ", 21, "3333"));
        dummyStudents.add(new Student(4, "ㅂㅎㄹ", 27, "4444"));
