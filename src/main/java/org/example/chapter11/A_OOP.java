...
//      : 적용 순서 x
//      : 모두 적용 x
//      : 서로 독립적 개념 x - 개념적으로 연결 o
//      - 상속, 캡슐화, 추상환, 다형성은 OOP의 4가지 특성
...
// 2) 올바른 설계 예시 - 각각의 클래스가 자신의 역할만을 담당 (유지 보수와 테스트가 쉬워짐)
class Janitor {
    void cleanClassroom() {
        System.out.println("교실을 청소합니다.");
    }
...
// 1) 잘못된 설계 예시 - 새로운 학생 유형이 생길 때 마다 if문 추가 (기존 코드 수정 필요)
class LunchMenu {
...
// 2) 올바른 설계 예시 - 부모의 activity()라는 추상메서드를 각 자식의 의도에 맞게 재정의
