...
// == 클래스 == //
// : 파일 ( 코드 저장소)
// 한개의 .java(자바) 파일에는 하나의 클래스가 포함(파일명과 동일)
// - 모든 코드가 클래스 안에서 동작
...
public class A_Array { // 클래스명 == 파일명 (파일명은 대문자로 시작 + UpperCamelCase 사용)
    ...
    public static void main(String[] args) {
        ...
        // cf) 참조 자료형의 출력
        // : 자바에서 '객체'를 sout으로 출력하면 내부적으로 객채.toString() 기능을 호출
        // > 모든 참조 자료형의 집합체
        String a = "안녕";
        System.out.println(a);
        System.out.println(a.toString()); // toString(): 문자열'로'
        // >> String 은 내부적으로 toString() 호출 시 실제 데이터값 자체를 반환하도록 설정
