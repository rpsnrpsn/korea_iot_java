...
class SchoolPrincipal {
    ...
    public void announce() {
        System.out.println("공부 열심히 하고 운동 열심히하고 일찍자고");
    }
}
...
public class E_Singleton {
    public static void main(String[] args) {
        ...
        // org.example.chapter13.SchoolPrincipal@7cca494b
        ...
        System.out.println(example1); // org.example.chapter13.Example@3b9a45b3
        System.out.println(example2); // org.example.chapter13.Example@7699a589
        System.out.println(example3); // org.example.chapter13.Example@58372a00
        System.out.println(example4); // org.example.chapter13.Example@4dd8dc3
