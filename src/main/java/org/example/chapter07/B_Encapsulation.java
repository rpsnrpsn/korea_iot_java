...
// - 객체 내부의 구현을 숨기고, 외무에서는 제공된 메서드를 통해서만 접근하도록 설정
...
class Student {
    ...
    public void setScore(int score) {
        if (score >= 0 && score <= 100) {
            ...
            System.out.println("유요하지 않은 점수입니다.");
        }
    }
}
...
public class B_Encapsulation {
    public static void main(String[] args) {
        ...
        // student.name = "ㅂㅎㅇ"; - private 설정 (해당 클래스에서는 접근 불가)

        student.setName("박현우");
        student.setAge(-28); // 유효하지 않은 나이입니다.
        student.setAge(28);
        student.setResidentNumber(12345);
        student.setScore(101); // 유요하지 않은 점수입니다.
