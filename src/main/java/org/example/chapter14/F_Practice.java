...
public class F_Practice {
    public static void main(String[] args) {
        ...
        studentScores.put("ㅂㅈㄷ", 90);
        studentScores.put("ㅂㅁㅇ", 80);
        studentScores.put("ㅂㅋㅊ", 95);
        studentScores.put("ㅁㄴㅇ", 85);
        studentScores.put("ㅁㅋㅌ", 100);
        ...
        // - 0~5점 중 하나를 반환함
        // Random() 클래스의 .nextInt(N): 0이상 N미만의 점수를 반환
