 ...
 *       - 디폴트 메서드, static 메서드는 여러 개 존재해도 가능
 * */
 ...
 *
 * + 인터페이스의 추상메서드 public abstract 생략
 *
 * (매개변수) -> { 구현부(실행문) };
 *
...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        System.out.println("람다식 결과1: " + calculator2.add(2,4));

        // cf) 람다식의 경우 구현부가 한 줄 일때 중괄호 생략 가능
